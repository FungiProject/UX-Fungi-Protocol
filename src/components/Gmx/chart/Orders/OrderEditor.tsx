...
import { updateOrderTxn } from "../../../../utils/gmx/domain/synthetics/orders/updateOrderTxn";
import {
...
export function OrderEditor(p: Props) {
  ...
  const isRatioInverted =
    markRatio?.largestToken.address === fromToken?.address;
          ...
          <>
            ...
            <BuyInputSection
              ...
              onClickTopRightLabel={() =>
                setTriggerPriceInputValue(
                  formatAmount(markPrice, USD_DECIMALS, indexPriceDecimals || 2)
                )
              }
