...
import GmxTab from "../../common/Tab/Tab";
...
import { useAvailableTokenOptions } from "../../../../utils/gmx/domain/synthetics/trade/useAvailableTokenOptions";
...
import { HIGH_PRICE_IMPACT_BPS } from "../../../../utils/gmx/config/factors";
  ...
  const markets = useMemo(
    () =>
      Object.values(marketsInfoData || {}).filter(
        (marketInfo) => !marketInfo.isDisabled
      ),
    [marketsInfoData]
  );
