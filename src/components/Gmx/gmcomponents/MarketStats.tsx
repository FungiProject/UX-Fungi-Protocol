    ...
    return (
        <>
            ...
            <div className="ml-6 mt-6">
                ...
                <CardRow label={`APR`} value={<AprInfo apr={apr} incentiveApr={incentiveApr} />} />
                ...
                />
                {shouldShowMoreInfo && (
                    <CardRow label={`More Info`} value={<BridgingInfo chainId={chainId} tokenSymbol={longToken?.symbol} />} />
                )}
