...
type createSwapLiFiOrderUserOpProps = {};

export async function createSwapLiFiOrderUserOp(
  chainId: number,
  p: createSwapLiFiOrderUserOpProps
  ...
  //   // const txnCreatedAtBlock = alchemyProvider.getBlockNumber();
  ...
  //   //   }
  //   // ).then(() => {  if (isMarketOrderType(p.orderType)) {
  //   //   const positionKey = getPositionKey(
  //   //     p.account,
  //   //     p.marketAddress,
  //   //     p.targetCollateralAddress,
  ...
  //   p: createIncreaseOrderUserOpProps;
  ...
  //     {
  //       method: "createOrder",
  //       params: subaccount ? [subaccount, orderParams] : [orderParams],
  //     },
  //   ];
  //   return multicall
  //     .filter(Boolean)
