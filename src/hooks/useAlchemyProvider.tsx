...
export const useAlchemyProvider = () => {
  ...
  const connectProviderToAccount = useCallback(
    (account?: Address) => {
      ...
      const connectedProvider = alchemyProvider.connect((rpcClient) => {
      ...
      console.log(
        "[useAlchemyProvider] Alchemy Provider connected to account %s  (Signer type %s)",
        connectedProvider.account.getAddress(),
        signer.signerType
      );
