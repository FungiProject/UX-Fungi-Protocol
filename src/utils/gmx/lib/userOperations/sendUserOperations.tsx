...
export async function sendUserOperations(alchemyProvider: AlchemyProvider, chainId: number, userOperations: UserOperation[], successMessage?: string) {
    ...
    try {
        ...
        const uo = await alchemyProvider.sendUserOperation(userOperations.length>1?userOperations:userOperations[0])
