import { getChainlinkChartPricesFromGraph } from "../../prices";
import { TVDataProvider } from "../../tradingview/TVDataProvider";
  ...
  override async getTokenChartPrice(
    ...
    const bars = await Promise.race([
      this.oracleKeeperFetcher
        .fetchOracleCandles(ticker, period, limit)
        .then((bars) => bars.reverse()),
